 ...
 * 
 * @since 6.36
 * @version 2014-11-27 上午9:57:25
 * @author zhangchd
 */
public class EndDateHandler extends CMBasedocAbstractHandler {
    ...
    public void afterEdit(CardPanelEvent ex) {
        ...
        if (CMValueCheck.isNotEmpty(beginDateObject)) {
            ...
            c.set(beginDate.getYear(), beginDate.getMonth() - 1, beginDate.getDay(), 23, 59, 59);

 ...
 * 
 * @since 6.36
 * @version 2014-12-3 下午3:04:57
 * @author zhangchd
 */
public class EndDate extends CMBasedocAbstractHandler {
    ...
    public void beforeEdit(CardPanelEvent ex) {
        ...
        UIRefPane refPane =
                (UIRefPane) e.getBillCardPanel().getHeadItem(MaterialPullPriceHeadVO.CENDDATE).getComponent();

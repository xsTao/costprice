...
public class CoprodcoefElementSystemFilter extends AbstractBDLinkageColumnListener {
    // 查询框
     ...
     */
    public CoprodcoefElementSystemFilter(QueryConditionDLGDelegator qryCondDLGDelegator, String fatherPath,
            String childPath) {
